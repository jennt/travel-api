...
# Task.create(route_id: 1, task_name: "mow grass", completed: false)
# Task.create(route_id: 1, task_name: "edging", completed: false)
# Task.create(route_id: 2, task_name: "pruning", completed: false)
Task.create(route_id: 4, task_name: "mulch", completed: false)
